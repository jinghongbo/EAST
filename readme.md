...
```
python multigpu_train.py --gpu_list=0 --input_size=512 --batch_size_per_gpu=14 --checkpoint_path=/data/east_icdar2015_resnet_v1_50_rbox/ \
...
run
```
python eval.py --test_data_path=/data/images/ --gpu_list=0 --checkpoint_path=/data/east_icdar2015_resnet_v1_50_rbox/ \
--output_dir=/data/
```
